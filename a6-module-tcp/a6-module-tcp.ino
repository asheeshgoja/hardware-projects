...
#ifndef A6board
SoftwareSerial A6board (3, 2); //r , t 14 , 12
#define A6baud 9600
#else
...
//  delay(5000);
//  Serial.println("command v");
//  DialVoiceCall();
//
//  Serial.println("dia complete");
//  delay(10000);
//  return;
...
bool sendSparkfunGSM(byte sparkfunType, float value1) {
  ...
  String publicKey   = "7JOAN3z8AMhrXrM4KoKa";//QGyWvOR04Mcqw7oZ2Qrp
  String privateKey = "mzZV6Wr8VbFxgxweAVAN";//Jqym6Ma281SynPV6qer5
  A6command("AT+CIPSTATUS", "OK", "yy", 10000, 2);
  A6command("AT+CGATT?", "OK", "yy", 20000, 2);
