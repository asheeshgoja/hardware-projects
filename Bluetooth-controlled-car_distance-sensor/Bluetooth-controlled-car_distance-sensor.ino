...
#define ENA 10  //enable A on pin 5 (needs to be a pwm pin)
...
#define ESP_8266_Pin 16 // Onboard LED
...
void setup()
{
  ...
  pinMode(LEDPin, INPUT); // Use LED indicator (if required)
  
  pinMode(ESP_8266_Pin, INPUT);
...
void loop()
{
  ...
  if(digitalRead(ESP_8266_Pin) == HIGH)
  {
    Serial.println("wifi cmd.. package in distress..locate package mode");
    state = '1';
    flag = 0;
  }
