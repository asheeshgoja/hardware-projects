...
void loop (){
  ...
  if(gprsReady == true){
    ...
    sendMQTTMessage("NodeHTU", "ec2-54-227-228-246.compute-1.amazonaws.com", "1883", "outTopic", jsonStr);
  }
  delay (15000);
}
...
// digitalWrite(13, HIGH);
 GPRS.println("AT+CSTT=\"apn.konekt.io\",\"\",\"\""); // Puts phone into GPRS mode
 Serial.println("AT+CSTT=\"apn.konekt.io\",\"\",\"\"");
